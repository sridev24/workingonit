 ...
 */
public class ReservationBookedEvent extends TabernaEvent {
    ...
    public ReservationBookedEvent(Integer number, Reservation reservation) {
        super(reservation);
        this.number = number;
        this.week = reservation.getWeek();
    }
