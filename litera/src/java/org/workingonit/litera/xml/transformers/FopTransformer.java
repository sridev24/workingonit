...
/**
 * The second pipeline transforms the incoming FO object into a PDF
 */
public class FopTransformer implements XmlTransformer, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        Validate.notNull(this.config, "config must be set!");

        this.fopFactory = FopFactory.newInstance();
        DefaultConfigurationBuilder cfgBuilder = new DefaultConfigurationBuilder();
        Configuration cfg = cfgBuilder.buildFromFile(this.config);
    ...
    public void transform(Source source, OutputStream output) throws Exception {
        ...
        Fop fop = this.fopFactory.newFop(MimeConstants.MIME_PDF, output);
