...
public class DatabaseDiscoveryMessageSourceTest extends AbstractTestNGSpringContextTests {

    private final static File outDir = new File("target/test/generated/labels");

    @Autowired
    @Qualifier("dbMessageSource")
    private DatabaseDiscoveryMessageSource source;
